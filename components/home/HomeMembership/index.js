          ...
          <div className="row">
            <div className="col-lg-7">
              <div className="images right">
                {/* 600x450 ratio or so */}
                <img className="img1 img-fluid" src="static/images/member1.jpg" alt="" />
                {/* 800x500 ratio or so */}
                <img className="img2 img-fluid" src="static/images/member2.jpg" alt="" />
              </div>
            </div>
            <div className="col-lg-5 pl-md-5 pl-sm-0">
              <div className="pb_accordion">
                <div className="item">
                  <button type="button" onClick={() => this.toggleSelect('attend')} aria-expanded={this.isVisible('attend') ? 'true' : 'false'} aria-controls="attendAccordion" className="pb_font-18 btn btn-link anchor-button">
                ...
                <div className="item">
                  <button type="button" onClick={() => this.toggleSelect('pay')} aria-expanded={this.isVisible('pay') ? 'true' : 'false'} aria-controls="payAccordion" className="pb_font-18 btn btn-link anchor-button">
                    Who/Where do I pay?
                ...
                <div className="item">
                  <button type="button" onClick={() => this.toggleSelect('financial')} aria-expanded={this.isVisible('financial') ? 'true' : 'false'} aria-controls="financialAccordion" className="pb_font-18 btn btn-link anchor-button">
                ...
                <div className="item">
                  <button type="button" onClick={() => this.toggleSelect('benfit')} aria-expanded={this.isVisible('benfit') ? 'true' : 'false'} aria-controls="benfitAccordion" className="pb_font-18 btn btn-link anchor-button">
                ...
                <div className="item">
                  <button type="button" onClick={() => this.toggleSelect('events')} aria-expanded={this.isVisible('events') ? 'true' : 'false'} aria-controls="eventsAccordion" className="pb_font-18 btn btn-link anchor-button">
                    What events count?
