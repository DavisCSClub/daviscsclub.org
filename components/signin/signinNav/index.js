...
class signinNav extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  constructor(props) {
    super(props);
        ...
        <div className="container">
          ...
          <Collapse isOpen={!this.state.collapsed} navbar id="boot-navbar">
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item active"><a className="nav-link" href="/signin">Signin</a></li>
            </ul>
          </Collapse>
        </div>
      </nav>
