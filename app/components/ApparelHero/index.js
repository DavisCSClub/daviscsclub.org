...
function ApparelHero() {
  ...
  return (
    <section className="pb_cover_v1 text-left cover-bg-black cover-bg-opacity-4" style={{ backgroundImage: 'url(/home/who2.jpg)' }} id="section-home">
        ...
        <div className="row align-items-center justify-content-end">
          <div className="col-md-6  order-md-1">
            ...
            <div className="sub-heading"><p className="mb-5">Get your department hoodies and club T-shirts here!</p>
              <p><a href="#apparel-form" role="button" className="btn smoothscroll pb_outline-light btn-xl pb_font-13 p-4 rounded-0 pb_letter-spacing-2">Order</a></p>
            </div>
